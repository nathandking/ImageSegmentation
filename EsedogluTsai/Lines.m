...
% Shapes created from lines image  
clear all
close all
tic
%% Read and plot initial image
u0=imread('../Images/Lines.jpg');
[M,N] = size(u0);
u0 = double(u0);
...
lambda=0.00002;   % tunable parameter
h=1.;   %  space step size

dt = 1*h^2;   % time step size
k = dt/3;   % time step size for diffusion part
